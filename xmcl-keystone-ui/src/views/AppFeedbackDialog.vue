...
const feedbackChannels = computed(() => [
  {
    title: "NeoTerra Rasmiy Sayti",
    description: "site.neoterra.uz — Server yangiliklari va ma'lumotlar",
    icon: "language",
    color: "#00BFFF",
    link: "https://site.neoterra.uz",
    target: "_blank",
    buttonText: "Kirish"
  },
  {
    title: "Telegram Hamjamiyati",
    description: "t.me/NeoTerraServer — Rasmiy Telegram kanal va guruh",
    icon: "send",
    color: "#0088cc",
    link: "https://t.me/NeoTerraServer",
    target: "_blank",
    buttonText: "A'zo bo'lish"
  },
  {
    title: "Discord Server",
    description: "discord.gg/neoterra — O'yinchilar bilan ovozli muloqot",
    icon: "discord",
    color: "#5865F2",
    link: "https://discord.gg/neoterra",
    target: "_blank",
    buttonText: "Qo'shilish"
  },
  {
    title: "YouTube Kanal",
    description: "youtube.com/@NeoTerraMC — Videolar va treylerlar",
    icon: "play_arrow",
    color: "#FF0000",
    link: "https://www.youtube.com/@NeoTerraMC",
    target: "_blank",
